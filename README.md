...
no notebook jupyter.Com o análise exploratória de dados foram identificadas características e 
classificadas as sequências que foram utilizadas no treino e teste.Dados de treinamento foram
usados para ensinar um modelo de aprendizado de máquina para ensinar um modelo de previsão. 
Train foi o método para medir a precisão do modelo. Todos os modelos foram testados.
O aprendizado de maquinas foi realizado a partir de redes neurais
